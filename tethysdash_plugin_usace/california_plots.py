...
class CaliforniaPlots(base.DataSource):
    container = "python"
    version = "0.0.1"
    name = "usace_california_plots"
    visualization_tags = [
        "usace",
        "time series",
        "chart",
    ...
    visualization_description = "A chart derived from USACE data at https://www.spk-wc.usace.army.mil/reports/hourly.html which depicts inflows, outflows, storage, and elevation for specified reservoirs"
    visualization_args = {
    ...
    def __init__(self, location, year, metadata=None):
        ...
        super(CaliforniaPlots, self).__init__(metadata=metadata)
